...
public class ServerThread implements Runnable {
    ...
    public String getStringFromUser(UserServer user1){
        ...
        try {
            ...
            while (!isClosed) {
                ...
                if(messageSplit[0].equals("client-verify")){
                    ...
                    UserServer user1 = userDAO.verifyUser(new UserServer(messageSplit[1], messageSplit[2]));
                    if(user1==null)
                        ...
                        Server.runAdmin.addMessage("["+user1.getID()+"] "+user1.getNickname()+ " đang online");
                ...
                if(messageSplit[0].equals("offline")){
                    ...
                    Server.runAdmin.addMessage("["+user.getID()+"] "+user.getNickname()+" đã offline");
